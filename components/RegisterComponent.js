...
import { View, StyleSheet, ScrollView, Image, TouchableOpacity, TouchableHighlight, Text, SafeAreaView } from 'react-native';
...
export default function Regiser() {
    ...
    const handleSubmit = (values) => {
        ...
        //const bvnnum = values.bvnnum;
        //const address = values.address;
        //alert("Current State is: " + JSON.stringify({firstname, lastname, telnum, email, bvnnum, address}));
        //dispatch(postFeedback(firstname, lastname, telnum, email, bvnnum, address));
            ...
            <ScrollView>
                <View style={styles.container}>
                    <View style={styles.imageContainer}>
                        <Image
                            source={{ uri: imageUrl }}
                            loadingIndicatorSource={{ uri: 'https://flyclipart.com/thumb2/account-avatar-client-person-profile-user-icon-196361.png' }}
                            style={styles.image}
                        />
                        <Icon
                            raised
