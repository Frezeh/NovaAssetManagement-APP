...
export default function Advisory () {
    ...
    function Advisory1 () {
        ...
        if (!fontsLoaded) {
         ...
         return (
             <Card title="08 MAY 2021" titleStyle={{fontFamily: 'Ubuntu_400Regular'}}>
                 ...
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
                 2. Diversify your assets- Diversification simply means investing in more than one industry or financial product so that all your eggs are not in one basket. This will help you spread your risks. By selecting different investments in various asset classes, you are reducing your exposure to risks.
                 </Text>
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
                 3. You need a financial expert or risk advisor– A professional asset manager sets you on the right path to risk mitigation. They can help you evaluate, predict, and ascertain potential risks. They can identify high risk to high return products, low risk with minimal returns and more. Most importantly, an expert will show you the best ways to manage your risks.
                 </Text>
             </Card>
             );
         }  
     ...
     function Advisory2 () {
        ...
        if (!fontsLoaded) {
         ...
         return (
             <Card title="28 JAN 2021" titleStyle={{fontFamily: 'Ubuntu_400Regular'}}>
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
     ...
     function Advisory3 () {
        ...
        if (!fontsLoaded) {
         ...
         return (
             <Card title="02 JAN 2021" titleStyle={{fontFamily: 'Ubuntu_400Regular'}}>
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
                 5 STEPS TO START INVESTING
                 </Text>
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}>            
                 Investing is simply using your money to create wealth for yourself by making the conscious decision to be financially smart through structured long or short term investments. Changing your spending habits so you can set aside money to invest may not seem so easy at first, but the benefits and the opportunity to improve your future makes it worth it.
                 </Text>
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
                 5 steps to start investing;
                 </Text>
                 ...
                 <Text style={{margin: 10, fontFamily: 'Ubuntu_400Regular'}}> 
                 Seek expert financial advice: contact an asset manager like Nova Asset Management to discuss your financial goals with an expert, so that you are clear on your investment strategy and achieving these goals in the long run.
                 </Text>
             </Card>
             );
         }  
